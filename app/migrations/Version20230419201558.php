 ...
 */
final class Version20230419201558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE site (id INT NOT NULL, customer_id INT NOT NULL, url TEXT NOT NULL, is_valid BOOLEAN NOT NULL, setting JSON DEFAULT NULL, type VARCHAR(255) NOT NULL, html_tag VARCHAR(255) DEFAULT NULL, is_image BOOLEAN NOT NULL, category TEXT NOT NULL, PRIMARY KEY(id))');
