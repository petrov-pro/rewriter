...
final class Version20230417203330 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE image (id INT NOT NULL, context_id INT NOT NULL, customer_id INT NOT NULL, keywords TEXT NOT NULL, data TEXT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE translate (id INT NOT NULL, context_id INT NOT NULL, customer_id INT NOT NULL, title TEXT NOT NULL, text TEXT DEFAULT NULL, description TEXT NOT NULL, lang VARCHAR(2) NOT NULL, token INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, lang TEXT NOT NULL, context_category TEXT DEFAULT NULL, PRIMARY KEY(id))');
